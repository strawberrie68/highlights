...
export default function Home() {
    ...
    // const google = () => {
    //     window.open("http://localhost:6010/auth/google", "_self")
    // }
    ...
    return (
        ...
        <div>
            <div>
                ...
                <div className='login-page flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8'>
                    ...
                    <div className='login-container bg-white w-96 mt-4 flex flex-col'>
                        <form
                    ...
                    <div className=' flex justify-center mt-4 mx-2 align-middle	 items-center'>
                        <div className='login-method google m-2  rounded-lg hvr-grow' >
                            <FontAwesomeIcon icon="fa-brands fa-google" />
                        </div>
                        <div className='login-method facebook m-2  rounded-lg hvr-grow' >
                            <FontAwesomeIcon icon="fa-brands fa-facebook" />
                        </div>
                        <div className='login-method github m-2 rounded-lg hvr-grow'>
